...
async def list_tasks(
    ...
    tasks = await TaskService.get_tasks(session, user_id, status_filter, sort)
...
async def update_task(
    ...
    if task_data.title is None and task_data.description is None and task_data.completed is None:
        raise HTTPException(
